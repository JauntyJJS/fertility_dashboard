...
+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Fertility Rate By        | [<i class="bi bi-file-earmark-spreadsheet"></i> Fertility Rate By Ethnic Group, Yearly.xlsx](data/Fertility Rate By Ethnic Group, Yearly.xlsx){target="_blank"}              |
| Ethnic Group, Yearly     |                                                                                                                                                                              |
| till 2023 in Excel       |                                                                                                                                                                              |
+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Live-Births By Sex And   | [<i class="bi bi-file-earmark-spreadsheet"></i> Live-Births By Sex And Ethnic Group, Monthly.xlsx](data/Live-Births By Sex And Ethnic Group, Monthly.xlsx){target="_blank"}  |
| Ethnic Group, Monthly    |                                                                                                                                                                              |
| till Dec 2023 in Excel   |                                                                                                                                                                              |
+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Quarto script to create  | [<i class="bi bi-file-code"></i> Quarto Script](index.qmd){target="_blank"}                                                                                                  |
| Dashboard                |                                                                                                                                                                              |
+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
