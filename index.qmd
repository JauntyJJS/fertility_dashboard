...
| Resource                 | Link                                                                                                         |
+==========================+==============================================================================================================+
| Births and Fertility     | [Website](https://www.singstat.gov.sg/find-data/search-by-theme/population/births-and-fertility/latest-data) |
| Data from Department     |                                                                                                              |
| of Statistics Singapore  |                                                                                                              |
+--------------------------+--------------------------------------------------------------------------------------------------------------+
| Fertility Rate By        | [Fertility Rate By Ethnic Group, Yearly.xlsx](data/Fertility Rate By Ethnic Group, Yearly.xlsx)              |
| Ethnic Group, Yearly     |                                                                                                              |
| till 2023 in Excel       |                                                                                                              |
+--------------------------+--------------------------------------------------------------------------------------------------------------+
| Live-Births By Sex And   | [Live-Births By Sex And Ethnic Group, Monthly.xlsx](data/Live-Births By Sex And Ethnic Group, Monthly.xlsx)  |
| Ethnic Group, Monthly    |                                                                                                              |
| till Dec 2023 in Excel   |                                                                                                              |
+--------------------------+--------------------------------------------------------------------------------------------------------------+
| Quarto script to create  | [Quarto Script](index.qmd)                                                                                   |
| Dashboard                |                                                                                                              |
+--------------------------+--------------------------------------------------------------------------------------------------------------+
